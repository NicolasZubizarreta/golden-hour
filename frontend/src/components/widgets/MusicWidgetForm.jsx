        ...
        <form className="flex min-h-0 flex-col gap-6 pb-8 pr-2 sm:pr-3 lg:overflow-y-auto lg:pb-2 lg:pr-4" onSubmit={onSubmit}>
          <div>
            ...
            <p className="mt-2 text-sm font-medium text-golden-muted">
              Colle un lien YouTube Music ou Deezer et le lecteur s'integrera automatiquement dans le dashboard.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            <span className="text-sm font-bold text-golden-text">Plateforme</span>
            <div className="bg-golden-input shadow-creuse rounded-golden flex items-center">
              <button
                type="button"
                onClick={() => onChange('platform', MUSIC_PLATFORMS.YOUTUBE_MUSIC)}
                className={platformButtonClass(draft.platform === MUSIC_PLATFORMS.YOUTUBE_MUSIC)}
              >
              ...
              <button
                ...
                className={platformButtonClass(draft.platform === MUSIC_PLATFORMS.DEEZER)}
              >
          ...
          <label className="flex flex-col gap-2">
            ...
            <input
              ...
              placeholder={draft.platform === MUSIC_PLATFORMS.DEEZER
            ...
            <span className="text-xs font-medium text-golden-muted">
              Tu peux coller un lien de partage classique, il sera converti automatiquement en lecteur integre.
            </span>
          </label>

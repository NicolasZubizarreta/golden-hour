...
import {
  buildChatPayloadFromDraft,
  createChatDraftFromData,
  createDefaultChatDraft,
  isChatWidgetSizeAllowed,
...
const WIDGET_DEFINITIONS = [
  ...
  },
  {
    type: 'CHAT',
    title: 'Chat',
    subtitle: 'Messages instantanes du groupe',
    enabled: true,
    requiredSize: 'RECT',
    surfaceClassName: 'bg-[linear-gradient(135deg,#111827_0%,#334155_52%,#FBBD23_100%)] text-white',
    iconClassName: 'bg-white/18 text-white',
    previewValue: 'Live',
    modalMaxWidthClass: 'max-w-4xl',
    cardComponent: ChatWidgetCard,
    formComponent: ChatWidgetForm,
    createDefaultDraft: createDefaultChatDraft,
    createDraftFromData: createChatDraftFromData,
    buildPayloadFromDraft: buildChatPayloadFromDraft,
    isSizeAllowed: isChatWidgetSizeAllowed,
    hideWhenSizeInvalid: true,
    renderCatalogIcon: () => (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2" d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.77 9.77 0 01-4-.82L3 20l1.38-3.45A7.45 7.45 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
      </svg>
    ),
  },

            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full bg-golden-input shadow-creuse rounded-golden px-5 py-3.5 pr-12 text-golden-text placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-golden-primary transition-all text-sm"

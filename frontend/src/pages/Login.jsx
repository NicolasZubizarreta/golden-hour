    ...
    <div className="relative min-h-screen bg-gradient-to-b from-golden-bg from-80% to-[#faeec5] font-inter text-golden-text flex flex-col">
      <header className="absolute top-0 left-0 w-full z-20">
        <div className="container-golden py-[32px] flex justify-between items-center">
          ...
          <Link to="/register" className="px-6 py-2 bg-gray-100 text-golden-text rounded-golden font-semibold hover:bg-gray-200 transition text-sm shadow-halo">
            Inscription
          </Link>
        </div>
      </header>
          ...
          <div className="w-full bg-golden-card p-10 md:p-12 rounded-golden shadow-halo z-10">
            ...
            <form className="space-y-6" onSubmit={handleLogin}>
              <div>
                ...
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-full bg-golden-input shadow-creuse rounded-golden px-5 py-3.5 pr-12 text-golden-text placeholder-golden-muted focus:outline-none focus:ring-2 focus:ring-golden-primary transition-all text-sm"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full flex justify-center items-center gap-2 font-inter font-bold text-lg py-4 rounded-golden transition-transform mt-2 shadow-halo ${
